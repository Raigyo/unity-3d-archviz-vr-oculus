...
> 🔨 House visit made with Unity 3D (ver. 2019.2.4f1). Visit a non existing house in a realistic 3D environment. It's the VR version for Oculus Rift of 'Archviz' work (see the repository [here](https://github.com/Raigyo/unity-3d-archviz)).
...
You need a hight-end computer and an Oculus Rift or an Oculus Rift S to run this demo.

### 1.1 Oculus Software

### 1.2 Windows x86_64

Download the zip with the game [here](xxx) [xxxMb] and unzip archviz-vr-windows64.zip on your computer.

In 'archviz-vr-windows64' launch architecture.exe by clicking on it to play.

### 1.3 Mac OSX

Download the zip with the game [here](xxx) [xxxMb] and unzip archviz-vr-mac-osx.zip on your computer.
